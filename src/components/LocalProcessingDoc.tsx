        ...
        <aside className="lg:w-80 space-y-md">
          ...
          <div className="bg-surface-container-lowest border border-outline-variant p-lg rounded-xl">
            ...
            <p className="text-body-sm leading-relaxed mb-md">
              ...
              (sem CNPJ e com a razão social substituída) é enviado à API da TESS — por padrão, através do nosso
              servidor, sem você precisar informar nenhuma chave. O PDF em si nunca é transmitido.
            </p>
          </div>
          <div className="bg-surface-container-lowest border border-outline-variant p-lg rounded-xl">
